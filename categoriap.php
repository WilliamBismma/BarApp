		...
		<div class="row">
			<div class="col-lg-12">
				...
				<header>
					...
					<h5>Categoras de los Productos</h5>
				</header>
				 <?php tabla_categoraisp($db); ?>
			</div>
			</div>
		</div>
		<!-- /.row -->
        ...
        <div class='modal-content bg-dark text-white'>
            ...
            <label></label>     
                <div class='form-group'>
                    ...
                    <input class='form-control' type='text' name ='categoria' id='categoria' placeholder='Ingrese el nombre de la categoria' required/>
                </div>
