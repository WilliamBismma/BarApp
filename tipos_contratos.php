        ...
        <div class='modal-content bg-dark text-white'>
            ...
            <label></label>     
                <div class='form-group'>
                    ...
                    <input class='form-control' type='text' name ='contrato' id='contrato' placeholder='Ingrese el nombre de la zona' required/>
                </div>
                <div class='form-group'>
                <label for='message-text' class='col-form-label'>Concepto:</label>
                <textarea class='form-control'  name='concepto' id='concepto' placeholder='Ingrese Descripción' required></textarea>
                </div> 
