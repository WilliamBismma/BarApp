        ...
        <div class='modal-content bg-dark text-white'>
            ...
            <label></label>     
                <div class='form-group'>
                    <label for='recipient-name' class='col-form-label'>Cargo / Puesto:</label>
                    <input class='form-control' type='text' name ='perfiles' id='perfiles' placeholder='Ingrese el nombre de la zona' required/>
                </div>
                 <input type='hidden' name ='tbl' value='perfiles'>        
            </div>                  
