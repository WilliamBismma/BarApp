        ...
        <div class='modal-content bg-dark text-white'>
            ...
            <label></label>     
                <div class='form-group'>
                    ...
                    <input class='form-control' type='text' name ='nombre' id='nombre' placeholder='Ingrese el nombre del usuario' required/>
                </div>
				<div class='form-group'>
                    <label for='recipient-name' class='col-form-label'>Cedula:</label>
                    <input class='form-control' type='number' name ='cedula' id='cedula' placeholder='Ingrese el numero de cedula' required/>
                </div>
				<div class='form-group'>
                    <label for='recipient-name' class='col-form-label'>Fecha y Hora:</label>
                    <input class='form-control' type='datetime-local' name ='fecha' id='fecha' placeholder='Ingrese la fecha y hora de la reserva' required/>
                </div>
				<div class='form-group'>
                    <label for='recipient-name' class='col-form-label'>Cantidad de Personas:</label>
                    <input class='form-control' type='text' name ='can_personas' id='can_personas' placeholder='Ingrese la cantidad de personas' required/>
                </div>
				<div class='form-group'>
                    <label for='recipient-name' class='col-form-label'>Observaciones:</label>
                    <input class='form-control' type='text' name ='observaciones' id='observaciones' placeholder='Ingrese observaciones de la reserva' required/>
                </div>
				
               	<input type='hidden' name ='tbl' value='reservas'>
				<input type='hidden' name ='est' value='Confirmado'>
            </div>
