...
StyleSwitcher.prototype.build = function () {
    ...
    styleSwitcherWrap.append($('<div/>').addClass('options-link').append($('<h6/>').html('Color de Fuentes'), fgBtnGroup));
    ...
    var resetLink = $('<a/>').html('Reiniciar').attr('href', '#').on(Metis.buttonPressedEvent, function (e) {
        $this.reset();
        e.preventDefault();
    });
